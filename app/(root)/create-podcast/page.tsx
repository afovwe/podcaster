...
const CreatePodcast = () => {
  ...
  const [imagePrompt, setImagePromt] = useState('');
  ...
  const [isSubmitting, setIsDubmiting ] = useState(false);
   // 1. Define your form.
            ...
            <div className=" flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => 
                ...
                <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus:right-1">
                  {voiceCategories.map
                  ((category) => (
                    <SelectItem key={category} value={category} className="capitalized focus:bg-orange-1">
                      {category}
                    </SelectItem>
                  ))}
                </SelectContent>
